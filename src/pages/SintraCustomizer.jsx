...
import SintraLogoControls from '../canvas/Sintra/SintraLogoControls'
import SintraTextControls from '../canvas/Sintra/SintraTextControls'
import PhotocardLogoControls from '../canvas/Photocard/PhotocardLogoControls'
import PhotocardTextControls from '../canvas/Photocard/PhotocardTextControls'
import LogoControls from '../canvas/Shirt/ShirtLogoControls'
import TextControls from '../canvas/Shirt/ShirtTextControls'
...
const Customizer = () => {
  ...
  const [activeFilterTab, setActiveFilterTab] = useState({
    ...
    backTextShirt: true,
    stylishShirt: false,
    frontLogoSintra: true,
    frontTextSintra: true,
    stylishSintra: true,
    frontLogoPhotocard: true,
    backLogoPhotocard: true,
    frontTextPhotocard: true,
    backTextPhotocard: true,
    stylishPhotocard: true,
  })
